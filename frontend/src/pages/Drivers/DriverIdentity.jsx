// src/pages/Drivers/DriverIdentity.jsx
// Displays a driver's public identity card: avatar, basic info, availability,
// skills, and bio with "read more" toggle.
...
export default function DriverIdentity({
  ...
  // Determine if bio exceeds the collapsed threshold (160 chars)
  const bioHasMore = (driver.bio || "").length > 160;

  return (
    <Card className="shadow-sm">
      {/* Header: avatar + name + rating + availability + quick actions */}
      <Card.Body className="d-flex gap-3 align-items-center">
        ...
        <div className="flex-grow-1">
          <div className="d-flex flex-wrap align-items-center gap-2">
            <h4 className="mb-0">{driver?.fullName || "Unnamed Driver"}</h4>
            <Badge bg="info">
          ...
          <div className="text-muted mt-2">
            <div>
              {driver?.phone || <span className="fst-italic">No phone</span>}
            </div>
            <div>
              {driver?.location || (
      ...
      <Card.Body className="pt-0">
        <div className="border-top pt-3">
          ...
          {Array.isArray(driver?.skills) && driver.skills.length > 0 ? (
        ...
        <div className="border-top pt-3">
          ...
          {driver?.bio ? (
            <div className="bg-light rounded p-3">
              ...
              >
                {bioExpanded ? driver.bio : truncate(driver.bio, 160)}
              </div>
              {bioHasMore && (
                <Button
                  variant="link"
            ...
            <div className="text-muted fst-italic">
              No bio yet. Add a few lines to attract companies & customers.
            </div>
          )}
        </div>
      </Card.Body>
