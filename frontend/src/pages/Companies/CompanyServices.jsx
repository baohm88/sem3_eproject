    ...
    useEffect(() => {
        if (initial) {
            setForm({
                ...
                price: initial.priceCents
                    ? String(initial.priceCents / 100)
                    : "",
            });
        } else {
                ...
                <Form>
                    ...
                    <Form.Group className="mb-3">
                        ...
                        <Form.Text className="text-muted">
                            Tip: nêu rõ phạm vi, thời gian, benefit cho driver &
                            rider.
                        </Form.Text>
                    </Form.Group>
                    <Form.Group>
                        <Form.Label>Unit Price/km (USD)</Form.Label>
                        <InputGroup>
                            <Form.Control
                                name="price"
...
export default function CompanyServices() {
    ...
    // load services when company ready
    useEffect(() => {
                    ...
                    <div className="d-flex align-items-center gap-2 flex-grow-1">
                        ...
                        <div>
                            ...
                            <div className="text-muted small">
                                Create attractive services to convert riders &
                                recruit drivers
                            </div>
                        </div>
                    </div>
                ...
                <Card className="border-0 shadow-sm">
                    <Card.Body className="text-center py-5">
                        ...
                        <p className="text-muted">
                            Hãy thêm dịch vụ đầu tiên để thu hút khách hàng và
                            tài xế.
                        </p>
